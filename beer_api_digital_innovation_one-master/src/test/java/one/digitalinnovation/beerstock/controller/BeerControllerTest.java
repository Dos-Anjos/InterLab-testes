...
//
        //when
//        doThrow(BeerNotFoundException.class).when(beerService).incrementId(INVALID_BEER_ID);
//
//        when
//                (beerService.increment(INVALID_BEER_ID, quantityDTO.getQuantity())).thenThrow(BeerNotFoundException.class);
//
