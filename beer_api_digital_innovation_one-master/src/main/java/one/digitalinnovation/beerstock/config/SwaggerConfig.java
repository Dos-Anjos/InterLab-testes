...
public class SwaggerConfig {
    ...
    private static final String CONTACT_NAME = "Rogerio Alves";
    private static final String CONTACT_GITHUB = "https://gtihub.com/Dos-Anjos";
    private static final String CONTACT_EMAIL = "rogerio.anjos@educacao.mg.gov.br";
