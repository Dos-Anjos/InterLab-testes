...
Foram trabalhados os principais conceitos para criação de testes unitários com JUnit e Mockito. 
Além disso, foram desenvolvidas funcionalidades da API se utilizando a técnica do TDD.
...
* E como atividade restaram para serem entregues pelos alunos os testes referentes a função de baixas no estoque.
