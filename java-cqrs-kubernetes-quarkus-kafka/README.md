## Digital Innovation: Expert class - Desenvolvimento de criação segregado de ambientes para controle de conta bancária.

Atividade de planejamento e criação do ambiente de deploy no AWS utilizando as técnicas e tecnologias:
